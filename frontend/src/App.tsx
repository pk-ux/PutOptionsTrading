  ...
  return (
    <div className="min-h-screen bg-dark-900 flex flex-col items-center justify-center p-4">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold gradient-text mb-2">PutYield</h1>
        <p className="text-gray-400">Get paid to own stocks at a discount.</p>
      </div>
      {children}
    </div>
  );
